...
namespace AQ1Report.BC
{
    class clsAQ1ReportBC
    {
        ...
        private static void CreateAQ1Report(string fileName, List<clsAQ1ReportDetailRow> AQ1ReportDetailRows)
        {
            ...
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "Q", "Previous Rdg", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "R", "Rate Charge", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "S", "Cut Remv Dt", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "T", "Cut Remv", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "U", "Rstr Rplc Dt", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "V", "Rstr Rplc", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "W", "Csmp By Meter", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "X", "Days", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "Y", "Csmp Billed", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "Z", "Water", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AA", "Sewarage", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AB", "Rent", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AC", "Bill Amt", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AD", "Additional", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AE", "Flat", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AF", "Date", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AG", "Page No", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AH", "Generated By", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AI", "Ward Name", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AJ", "Reading Cycle", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AK", "Year", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AL", "Sheet No", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AM", "Row No", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AN", "CCN 10", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AO", "Flag", clsOpenXmlBC.CellDataTypeEnum.SharedString);
            ...
            foreach (clsAQ1ReportDetailRow detailRow in AQ1ReportDetailRows)
            {
                ...
                if ((detailRow.G_row1_GAP == "Meter") && (detailRow.H_row1_CurrentDate == "Reading") && (detailRow.I_row1_PreviousDate == "Not Entered"))
                    ...
                    clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "J", "Permanently Cutoff", clsOpenXmlBC.CellDataTypeEnum.SharedString); clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "K", detailRow.X_row1_CutDate.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                ...
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "T", detailRow.J_row2_CutRemv.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "U", detailRow.K_row1_RstrRplcDt.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "V", detailRow.K_row2_RstrRplc.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "W", detailRow.L_row1_CsmpByMeter.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "X", detailRow.M_row1_Days.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "Y", detailRow.N_row1_CsmpBilled.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "Z", detailRow.O_row1_Water.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AA", detailRow.P_row1_Sewarage.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AB", detailRow.Q_row1_Rent.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AC", detailRow.R_row1_BillAmt.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AD", detailRow.S_row1_Additional.ToString(), clsOpenXmlBC.CellDataTypeEnum.AutoDetect);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AE", detailRow.T_row1_Flat.ToString(), clsOpenXmlBC.CellDataTypeEnum.AutoDetect);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AF", detailRow.HeaderRow.Date.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AG", detailRow.HeaderRow.PageNo.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AH", detailRow.HeaderRow.GeneratedBy.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AI", detailRow.HeaderRow.WardName.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AJ", detailRow.HeaderRow.ReadingCycle.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AK", detailRow.HeaderRow.Year.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AL", detailRow.HeaderRow.ExcelWorkSheetNo.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AM", detailRow.ExcelRowNo.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AN", detailRow.E_row1_CCN10.ToString(), clsOpenXmlBC.CellDataTypeEnum.Number);
                clsOpenXmlBC.SetCell(shareStringPart, worksheetPart, rowIndex, "AO", detailRow.U_row1_Flag.ToString(), clsOpenXmlBC.CellDataTypeEnum.SharedString);
